...
Route::group(['middleware' => 'admin.auth.admin:admin'], function () {
    ...
    Route::prefix('/areas')->as('areas.')->group(function () {
        Route::controller(App\Admin\Http\Controllers\Area\AreaController::class)->group(function () {
            ...
            Route::get('/get-wards/{districtCode}', 'App\Admin\Http\Controllers\Articles\ArticlesController@getWardsByDistrict')->name('getWards');

            Route::get('/get-districts/{provinceCode}', 'App\Admin\Http\Controllers\Articles\ArticlesController@getDistrictsByProvince')->name('getDistricts');
    ...
    Route::prefix('/supperAdmin_settings')->as('supperAdmin_settings.')->group(function () {
        Route::controller(App\Admin\Http\Controllers\SupperAdmin_settings\SupperAdmin_settingsController::class)->group(function () {
    ...
    //***** -- Contact_admin -- ******* //
    Route::prefix('/contact_admin')->as('contact_admin.')->group(function () {
        Route::controller(App\Admin\Http\Controllers\Contact_admin\Contact_adminController::class)->group(function () {
    ...
    //***** -- Commission_detail -- ******* //
    Route::prefix('/commission_detail')->as('commission_detail.')->group(function () {
        Route::controller(App\Admin\Http\Controllers\CommissionDetail\CommissionDetailController::class)->group(function () {
            Route::group(['middleware' => ['permission:viewCommission_detail', 'auth:admin']], function () {
                Route::get('/', 'index')->name('index');
                Route::get('/sua/{id}', 'edit')->name('edit');
            });

            Route::group(['middleware' => ['permission:updateCommission_detail', 'auth:admin']], function () {
                Route::put('/sua', 'update')->name('update');
            });

            Route::group(['middleware' => ['permission:deleteCommission_detail', 'auth:admin']], function () {
                Route::delete('/xoa/{id}', 'delete')->name('delete');
            });
        });
    });
