        ...
        <div class="row card-body">
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <x-input type="number" name="indirect_commission_default" :value="$commission->indirect_commission_default" 
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <x-input type="number" name="direct_commission_default" :value="$commission->direct_commission_default" 
