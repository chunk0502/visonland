    ...
    <div class="card">
        ...
        <div class="row card-body">
            ...
            <div class="mb-3">
                ...
                <x-input name="broker_id" :value="$user->id" type="hidden"/>
            </div>
        </div><!-- customer_name -->
            <div class="col-12">
                <div class="mb-3">
                    <label class="control-label">{{ __('nameCustomer') }} <span style="color:red;">*</span>:</label>
                    <x-input name="customer_name" :value="old('customer_name')"
                        :required="true" placeholder="{{ __('nameCustomer') }}" />
                </div>
            </div><!-- phone -->
            <div class="col-12">
                <div class="mb-3">
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <x-input name="refferal_code" :value="$user->refferal_code" readonly
