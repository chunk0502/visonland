								...
								<div class="card card-sm">
								  <div class="card-body">
									<div class="row align-items-center">
									  <div class="col-auto">
											<i class="iconModuleMevivu ti ti-user"></i>
										</div>
									  <div class="col">
										<div class="font-weight-medium">
										  <a href="customers">Bảng khách hàng</a>
										</div>
										<div class="text-secondary">
										  Số lượng: {{ $rowCountCustomers }}
										</div>
									  </div>
									</div>
								  </div>
...
<div class="col-sm-6 col-lg-3">
								<div class="card card-sm">
								  <div class="card-body">
									<div class="row align-items-center">
									  <div class="col-auto">
											<i class="iconModuleMevivu ti ti-fingerprint"></i>
										</div>
									  <div class="col">
										<div class="font-weight-medium">
										  <a href="supperAdmin_settings">Quản lý SuperAdmin</a>
										</div>
										<div class="text-secondary">
										  Số lượng: {{ $rowCountSupperAdmin_settings }}
										</div>
									  </div>
									</div>
								  </div>
								...
								<div class="card card-sm">
								  <div class="card-body">
									<div class="row align-items-center">
									  ...
									  <div class="col">
										<div class="font-weight-medium">
										  <a href="commission_detail">Hoa hồng chi tiết</a>
										</div>
										<div class="text-secondary">
