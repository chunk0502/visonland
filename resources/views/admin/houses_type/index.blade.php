                ...
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('typeOfHouseInformation') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header justify-content-between">
                    ...
                    <x-link :href="route('admin.houses-type.create')" class="btn btn-primary"><i
                            class="ti ti-plus"></i>{{ __('addTypeOfHouse') }}</x-link>
                </div>
                <div class="card-body">
...
@push('custom-js')
    ...
    @include('admin.houses_type.scripts.datatable')
@endpush
