...
class NotificationDataTable extends BaseDataTable
{
    ...
    protected function setCustomColumns(){
        $this->customColumns = $this->traitGetConfigDatatableColumns('notification'); // Truyền vào tên bảng trong datatable_columns Config
    }
	...
	protected function setCustomRawColumns(){
        $this->customRawColumns = ['id', 'action','content'];
    }
    protected function rawColumns(){
        $this->instanceDataTable = $this->instanceDataTable->rawColumns(['id','user_id','action','admin_id','content']);
    }
    protected function editColumnUsername(){
        $this->instanceDataTable = $this->instanceDataTable->editColumn('user_id', function ($notification) {
            ...
            return '<a href="' . route('admin.user.edit', $userId) . '">' . $username . '</a>';
        });
    }
