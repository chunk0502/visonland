...
class CustomerRegistrationsDataTable extends BaseDataTable
{
    ...
    {
        $this->customColumns = $this->traitGetConfigDatatableColumns('customerRegistrations'); // Truyền vào tên bảng trong datatable_columns Config
    ...
    protected function addColumnCustomerName()
    {
        $this->instanceDataTable = $this->instanceDataTable->addColumn('customer_name', function ($registration) {
            return $registration->customers ? $registration->customers->customer_name : 'N/A';
        });
    }
