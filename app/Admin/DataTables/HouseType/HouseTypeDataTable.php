...
namespace App\Admin\DataTables\HouseType;

use App\Admin\DataTables\BaseDataTable;
use App\Admin\Repositories\HouseType\HouseTypeRepositoryInterface;
use App\Admin\Traits\GetConfig;

class HouseTypeDataTable extends BaseDataTable
{

    use GetConfig;

    // ID ( Client ) của bảng DataTable
    protected $nameTable = 'housetypeTable';
    ...
    {
        return [
            'id' => 'admin.houses_type.datatable.id',
            'action' => 'admin.houses_type.datatable.action',
        ];
    }
    ...
    {
        $this->customColumns = $this->traitGetConfigDatatableColumns('houses_type'); // Truyền vào tên bảng trong datatable_columns Config
    }
