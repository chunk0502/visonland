...
class CommissionDataTable extends BaseDataTable
{
    ...
    public function getView(){
        return [
			'id' => 'admin.commission.datatable.id',
    ...
    protected function setCustomColumns(){
        $this->customColumns = $this->traitGetConfigDatatableColumns('commission'); // Truyền vào tên bảng trong datatable_columns Config
    }
	...
	protected function setCustomEditColumns(){
        ...
        $this->customEditColumns = [
            'id' => $this->view['id'],
            'indirect_commission_default' => '{{ $indirect_commission_default }}%',
            'direct_commission_default' => '{{ $direct_commission_default }}%',
        ];
    }
